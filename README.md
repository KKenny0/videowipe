...
![Cleanup workspace: video and processing area on the left, removable targets and protection controls on the right](pics/web-ui/workspace-review.jpg)
...
Edits are saved, and unchanged trials can be reused. See [workspace details](docs/cleanup-workspace.md) for recovery, protection, cache limits, and SDK options.
